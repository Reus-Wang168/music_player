...
import 'package:music_player/common_widget/recommender_view_cell.dart';
import 'package:music_player/view_model/home_view_model.dart';
import 'package:music_player/view_model/splash_view_model.dart';

import '../../common/color_extension.dart';
import '../../common_widget/play_list_cell.dart';
        ...
        title: Row(
          children: [
            Expanded(
              ...
              child: TextField(
                controller: homeVM.textSerach.value,
            ...
            SizedBox(
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return RecommenderViewCell(mObj: mObj);
                  }),
            ),
            Divider(
